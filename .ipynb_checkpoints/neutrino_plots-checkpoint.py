...
#     plt.ylim(0, plt.ylim()[1])
    # plt.ylim(0, 10)
    # plt.ylim(0, 20) #for amy
    plt.ylim(0,15) #For ilya
    # plt.axvline(2019, c='k', ls='--')
    # plt.axvline(2026, c='k', ls='--')  #For amy
    plt.axvline(2022, c='k', ls='--')    #For ilya
#     ticks = plt.xticks()[0]
#   plt.xticks(ticks[ticks%0==0], [str(int(tick)) for tick in ticks[ticks%1==0]])
    # plt.xticks([2013,2015,2017,2019,2021,2023])
    # plt.xticks([2013,2015,2017,2019,2021,2023,2025,2027,2029])  #For amy
    plt.xticks([2012,2014,2016,2018,2020,2022,2024,2026])    #For ilya
